...
I write them, commit them, and that is the section. Everything that made this the
most complicated part of the project is simply gone.
...
- `author` stays in the schema (`sivan` or `her`) with a gold seal for hers, so
  if I ever want to include something she wrote to me, it renders correctly with
  no code change.
...
- Anything left that I would rather write myself.

---

## What I still need to write

The layout is built with placeholder copy. These matter more than any remaining
feature, and most of the verses in `content.js` are still about Shiva rather than
about her. I need to fill these in once I have worked out what I want to say.
